...
namespace Service
{
    ...
    {
        public async Task<IEnumerable<ProductDto>> GetAllProductAsync(ProductQueryParms queryParms)
        {
            var Specifications=new ProductWithBrandAndTypeSpecifications(queryParms);
